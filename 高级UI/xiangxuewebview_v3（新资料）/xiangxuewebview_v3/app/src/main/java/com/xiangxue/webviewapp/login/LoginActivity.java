...
public class LoginActivity extends AppCompatActivity {
    ...
    private static ILoginService mLoginService = RouteServiceManager.provide(ILoginService.class, AppRouter.APP_LOGIN_SERVICE);
    ...
    private void init() {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // Hide Keyboard
                PreferencesUtil.getInstance().setString("UserName", inputEmail.getEditText().getText().toString());
